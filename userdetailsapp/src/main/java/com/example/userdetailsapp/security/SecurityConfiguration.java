package com.example.userdetailsapp.security;
...
import com.example.userdetailsapp.serviceimpl.UserDetailsServiceImpl2;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.authorizeRequests().antMatchers("/v1/deleteUserDetails").hasRole("ADMIN").and().httpBasic();
